...
// Wire the getCachedJson mock to delegate to axios.get before every test.
// App.checkOAuthSession calls getCachedJson(url) which returns { data: ... }.
// axios.get is what the test helpers (mockAllUnauthenticated etc.) configure,
// so bridging here lets the existing helpers control auth responses end-to-end.
beforeEach(() => {
