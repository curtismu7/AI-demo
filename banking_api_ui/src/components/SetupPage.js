      ...
      >
        ...
        >
          ...
          >
            ...
            folder that contains <code>scripts/setup-vercel-env.js</code>), not
            inside <code>banking_api_ui/</code>. Clone the repo, run{" "}
        ...
        <div style={cardStyle}>
          ...
          <div style={{ marginBottom: "0.75rem" }}>
            ...
            <button
              ...
              style={btnStyle}
              onClick={() =>
                copy("npm run setup:vercel:check", "npm run setup:vercel:check")
              }
            >
          ...
          >
            Optional reminder (paste into terminal after <code>cd</code> to repo
            root):
          </p>
          <button
            type="button"
          ...
          >
            <li>
              See <code>.env.vercel.example</code> at the repo root for variable
              names.
            </li>
            <li>
        ...
        <div style={cardStyle}>
          ...
          >
            ...
            repo root; use <code>--probe</code> to verify Management API access
        ...
        >
          ...
          >
            ...
            <strong>client_credentials</strong> — <code>pingone_client_id</code>{" "}
            ...
            <code>PINGONE_AUTHORIZE_WORKER_*</code> (PingOne Authorize only)
            unless you grant the same app Management roles in PingOne.
          </p>
          {workerCred && (
            <ul
              style={{
          ...
          >
            If the server has <code>SETUP_MASTER_KEY</code>, paste it here (sent
            as <code>X-Setup-Master-Key</code> only for this request; not
            stored).
          </p>
          <input
            type="password"
        ...
        >
          ...
          >
            The learning panels (LLM Landscape, IETF Standards, Agent Builders,
            AI Platforms, OAuth Specs) need periodic updates as new RFC drafts
            publish, model families change, and agent frameworks release new
            versions. A ready-made agent prompt automates this refresh.
          </p>
          <p
            style={{
              margin: "0 0 0.75rem 0",
          ...
          >
            <strong>How to use it:</strong> Open the repo in Claude Code, paste
            the contents of <code>EDUCATION_REFRESH_PROMPT.md</code> as your
            first message, and let the agent run. It will research current RFC
            statuses, model versions, and framework releases, then update all
            education panel files and create a new <strong>What's New</strong>{" "}
            page that lists every change made in that refresh. Recommended
            frequency: every 3 months, or after any major RFC publication.
          </p>
