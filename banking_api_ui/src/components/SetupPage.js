...
export default function SetupPage() {
  ...
  const headerStyle = {
    background: 'linear-gradient(to bottom, var(--brand-navy) 0%, var(--brand-navy) 100%)',
    color: 'white',
    padding: '1rem 0',
    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      <div style={headerStyle}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
            <Link to="/" style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.875rem' }}>← Home</Link>
            <Link
              to="/onboarding"
      ...
      <div className="container" style={{ padding: '2rem 20px', maxWidth: '800px' }}>
        <div style={{ ...cardStyle, background: '#eff6ff', borderColor: '#bfdbfe' }}>
          <h2 style={{ fontSize: '1.1rem', margin: '0 0 0.5rem 0', color: 'var(--brand-navy)' }}>Where to run commands</h2>
          <p style={{ margin: 0, color: 'var(--brand-navy)', fontSize: '0.9375rem', lineHeight: 1.6 }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ marginBottom: '0.75rem' }}>
            ...
            <button
              type="button"
              style={{ ...btnStyle, background: 'var(--brand-navy)', color: '#fff', borderColor: 'var(--brand-navy)' }}
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <Link to="/onboarding" style={{ fontSize: '0.9375rem', color: 'var(--brand-navy)' }}>PingOne checklist</Link>
        </div>
      </div>
    </div>
  );
