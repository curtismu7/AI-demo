...
const SCENARIO_STEPS_TF = {
  ...
  "api-key-path": [
    ...
    },
    {
      regionIds: ["mcp-gateway-tf"],
      colorClass: "active-permit",
      label: "API-KEY PATH: no backend call — gateway-terminating swap",
      token: {
        type: "API Key Swap",
        _type: "mcp",
        credentialPath: "api_key",
        swap: "OAuth bearer dropped; X-API-Key attached",
    ...
    },
    {
      regionIds: ["chatbot"],
      colorClass: "active",
      label: "API-KEY PATH: SPA routed to /path/apikey-info",
      token: {
        type: "SPA route",
        _type: "mcp",
        credentialPath: "api_key",
