  ...
  "get-accounts": [
    {
      regionIds: ["agent1", "llm"],
      colorClass: "active",
      label: "LLM decides: get_my_accounts (banking:read)",
      token: {
        type: "LLM Reasoning",
        _type: "mcp",
        model: "claude-3-5-sonnet",
    ...
    },
    {
      regionIds: ["pingauthorize-tf"],
      colorClass: "active-permit",
      label: "PERMIT — banking:read sufficient",
      token: {
        type: "Authorization Decision",
        _type: "permit",
        decision: "✅ PERMIT",
  ...
  withdrawal: [
    {
      regionIds: ["agent1", "llm"],
      colorClass: "active",
      label: "LLM decides: create_transfer (banking:write)",
      token: {
        type: "LLM Reasoning",
        _type: "mcp",
        model: "claude-3-5-sonnet",
  ...
  "api-key-path": [
    {
      ...
      token: {
        ...
        tool: "show_mortgage",
        note: "Gateway receives bearer — will enforce banking:mortgage:read, then swap for api_key disposition. No RFC 8693 exchange on this path.",
      },
    },
    {
      regionIds: ["mcp-gateway-tf"],
      ...
      token: {
        ...
        swap: "banking:mortgage:read verified; OAuth bearer dropped; X-API-Key + X-User-Sub attached",
