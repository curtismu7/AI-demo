...
/**
 * Renders the gateway RFC 7662 introspection card (Phase 259).
 * Called by the gateway middleware after introspection confirms token liveness.
 */
...
/**
 * Renders the gateway PingOne Authorize decision card (Phase 259).
 * Called by authorizeMcpRequest after the Authorize endpoint makes a PERMIT/DENY/INDETERMINATE decision.
 */
