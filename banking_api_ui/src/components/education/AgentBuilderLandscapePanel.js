...
function FrameworkCard({ name, category, tagline, color = 'var(--brand-navy)', children }) {
  return (
    <div style={{
...
function OpenSourceContent() {
  return (
    <>
      ...
      <FrameworkCard name="Microsoft AutoGen" category="Multi-agent conversation" tagline="Orchestrate multiple AI agents in collaborative conversations" color="var(--brand-navy)">
        <ul style={{ paddingLeft: 20, margin: 0 }}>
      ...
      <FrameworkCard name="Phidata / Agno" category="Full-stack agent framework" tagline="Agents with memory, knowledge, tools, and reasoning baked in" color="var(--brand-navy)">
        <ul style={{ paddingLeft: 20, margin: 0 }}>
...
function CommercialContent() {
  return (
    <>
      ...
      <FrameworkCard name="Microsoft Copilot Studio" category="Low-code agent builder" tagline="Build custom copilots — from no-code to pro-code" color="var(--brand-navy)">
        <ul style={{ paddingLeft: 20, margin: 0 }}>
