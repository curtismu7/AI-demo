...
export const EDUCATION_COMMANDS = [
  ...
  { id: 'mcp-mfa-gate', label: 'MCP: MFA gate on tool discovery', panel: EDU.MCP_PROTOCOL, tab: 'mfa-gate' },
  ...
  { id: 'step-up-device-auth', label: 'Step-up: deviceAuthentications API', panel: EDU.STEP_UP, tab: 'device-auth' },
  ...
  { id: 'how-llms-work', label: 'How LLMs Work', panel: EDU.LLM_LANDSCAPE, tab: 'howllmswork' },
  ...
  { id: 'pinggateway', label: 'PingGateway MCP Security', panel: EDU.PINGGATEWAY_MCP, tab: 'overview' },
  { id: 'pinggateway-compare', label: 'Custom vs PingGateway', panel: EDU.PINGGATEWAY_MCP, tab: 'comparison' },
  { id: 'architecture', label: 'C4 Architecture Diagram', panel: EDU.ARCHITECTURE_DIAGRAM, tab: 'context' },
  { id: 'architecture-bff', label: 'BFF Component Diagram', panel: EDU.ARCHITECTURE_DIAGRAM, tab: 'component' },
  ...
  { id: 'id-jag-limitations', label: 'ID-JAG: Limitations', panel: EDU.ID_JAG, tab: 'limitations' },
  { id: 'id-jag-vs-8693', label: 'ID-JAG vs RFC 8693', panel: EDU.ID_JAG, tab: 'vs-rfc8693' },
  { id: 'intent-delegation', label: 'Intent-Bound Delegation', panel: EDU.INTENT_DELEGATION, tab: 'overview' },
  { id: 'intent-delegation-industry', label: 'Intent Delegation: Industry Landscape (AP2, Mastercard, AffixIO)', panel: EDU.INTENT_DELEGATION, tab: 'industry' },
  { id: 'intent-delegation-demo', label: 'Intent Delegation: How This Demo Implements It', panel: EDU.INTENT_DELEGATION, tab: 'in-this-demo' },
  { id: 'intent-delegation-pingone', label: 'Intent Delegation: PingOne Approach', panel: EDU.INTENT_DELEGATION, tab: 'pingone' },
];
