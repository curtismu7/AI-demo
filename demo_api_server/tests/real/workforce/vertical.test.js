...
describe(`Vertical manifest — ${VERTICAL} (real)`, () => {
  ...
  it('GET /api/config/vertical returns activeVertical=workforce', () => {
    expect(manifest.activeVertical).toBe(VERTICAL);
  });

  it('manifest terminology matches config/verticals/workforce.json', () => {
  ...
  it('manifest identity matches config/verticals/workforce.json', () => {
