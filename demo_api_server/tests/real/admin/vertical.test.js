...
describe(`Vertical manifest — ${VERTICAL} (real)`, () => {
  ...
  it('GET /api/config/vertical returns activeVertical=admin', () => {
    expect(manifest.activeVertical).toBe(VERTICAL);
  });

  it('manifest terminology matches config/verticals/admin.json', () => {
  ...
  it('manifest identity matches config/verticals/admin.json', () => {
