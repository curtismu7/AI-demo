...
describe('buildToolSchemasForAgentForVertical', () => {
  ...
  it('overrides create_deposit description for retail vertical (uses balance term)', () => {
    const schemas = buildToolSchemasForAgentForVertical(retailManifest);
  ...
  it('overrides create_withdrawal description for retail vertical (uses balance term)', () => {
    const schemas = buildToolSchemasForAgentForVertical(retailManifest);
  ...
  it('overrides create_transfer description for retail vertical (uses highValueAction term)', () => {
    const schemas = buildToolSchemasForAgentForVertical(retailManifest);
  ...
  it('returns an array with name, description, inputSchema for each tool', () => {
    const schemas = buildToolSchemasForAgentForVertical(retailManifest);
