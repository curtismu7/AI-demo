...
| Helix LLM integration — real conversation API: createConversation → sendMessage → poll for class=complete; x-api-key auth; base URL normalisation; agent name field | active | `banking_api_server/services/helixLlmService.js`, `banking_api_ui/src/components/HelixPanel.jsx` | `s:helixLlmService.test.js` |
