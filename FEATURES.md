...
| Agent Demo Guide — interactive modal showing 12 compliance verification steps mapped to 6 real-world banking scenarios using reliable action chips (💰 My Accounts, 🧪 Test Wrong Scope, 🔐 Test HITL Transfer, 📱 Test OTP Challenge, 🔥 Full Compliance); expandable steps with explanations and watch instructions; accessible from AdminSideNav | active | `banking_api_ui/src/components/AgentDemoGuide.jsx`, `banking_api_ui/src/components/AgentDemoGuide.css`, `banking_api_ui/src/components/AdminSideNav.jsx` | — |
