...
```json
{
  ...
  "config": {
    "gatewayServiceUri": "${env['P1AZ_GATEWAY_SERVICE_URI']}",
    "secretsProvider": "SecretsStore",
...
The `gatewayCredentialSecretId` follows the same dot-to-uppercase-underscore convention as other secret IDs: `p1az.gateway.credential` → `P1AZ_GATEWAY_CREDENTIAL` env var.
